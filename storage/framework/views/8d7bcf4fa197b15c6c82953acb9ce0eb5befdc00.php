                ...
                if (current <= Listings.length - 1) {
                    ...
                    if(current == 1){
                        ...
                        if(title == '' || description == ''){
                            ...
                            toastr_warning_js("<?php echo e(__('Description must not greater than 250 charecter !')); ?>");
                            return false;
                        }else{
                            $.ajax({
...
<?php /**PATH C:\xampp\htdocs\nexelit\core\resources\views/frontend/user/freelancer/account/account-setup-js.blade.php ENDPATH**/ ?>