                ...
                <div class="customMarkup__single">
                    <div class="customMarkup__single__item">
                        <div class="customMarkup__single__item__flex">
                            <h4 class="customMarkup__single__title"><?php echo e(__('All Blogs')); ?></h4>
...
<?php endif; ?>
                                ...
                                <a href="<?php echo e(route('admin.blog.create')); ?>" class="btn btn-primary btn-md d-flex align-items-center">
                        ...
                        <div class="customMarkup__single__inner mt-4">
                            ...
                            <div class="custom_table style-04 search_result">
                                <?php echo $__env->make('blog::backend.search-result', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
                            <!-- Table End -->
                        </div>
                    </div>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
    <?php echo $__env->make('blog::backend.blog-js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\nexelit\core\Modules/Blog\Resources/views/backend/all-blog.blade.php ENDPATH**/ ?>