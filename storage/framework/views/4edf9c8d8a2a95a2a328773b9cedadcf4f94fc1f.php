    ...
    (function($){
        ...
        $(document).ready(function(){
            ...
            $(document).on('click', '.pagination a', function(e){
                ...
                $.ajax({
                    url:"<?php echo e(route('client.ticket.paginate.data').'?page='); ?>" + page,
            ...
            $(document).on('keyup','#string_search',function(){
                ...
                $.ajax({
                    url:"<?php echo e(route('client.ticket.search')); ?>",
                    method:'POST',
                    data:{string_search:string_search},
                    success:function(res){
...
<?php /**PATH C:\xampp\htdocs\nexelit\core\Modules/SupportTicket\Resources/views/client/ticket-js.blade.php ENDPATH**/ ?>