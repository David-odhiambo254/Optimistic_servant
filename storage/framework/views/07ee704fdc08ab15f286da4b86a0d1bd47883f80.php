    ...
    (function($){
        ...
        $(document).ready(function(){
            ...
            function blogs(page,string_search){
                $.ajax({
                    url:"<?php echo e(route('admin.blog.paginate.data').'?page='); ?>" + page,
            ...
            $(document).on('keyup','#string_search',function(){
                ...
                $.ajax({
                    url:"<?php echo e(route('admin.blog.search')); ?>",
                    method:'GET',
                    data:{string_search:string_search},
                    success:function(res){
...
<?php /**PATH C:\xampp\htdocs\nexelit\core\Modules/Blog\Resources/views/backend/blog-js.blade.php ENDPATH**/ ?>