                ...
                <div class="setup-wrapper-finish-profile-flex">
                    <div class="setup-wrapper-finish-profile-thumb profile_photo_area">
                        <?php if(!empty(Auth::user()->image)): ?>
                            <img src="<?php echo e(asset('assets/uploads/profile/'.Auth::user()->image) ?? ''); ?>" alt="profile.img">
                        <?php else: ?>
...
<?php /**PATH C:\xampp\htdocs\nexelit\core\resources\views/frontend/user/freelancer/account/hourly/hourly-rate.blade.php ENDPATH**/ ?>