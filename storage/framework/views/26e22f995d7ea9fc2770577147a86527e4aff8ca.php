    ...
    (function($){
        ...
        $(document).ready(function(){
            ...
            function projects(page,string_search){
                $.ajax({
                    url:"<?php echo e(route('admin.job.history.paginate.data').'?page='); ?>" + page,
            ...
            $(document).on('keyup input','#string_search',function(){
                ...
                $.ajax({
                    url:"<?php echo e(route('admin.job.history.search')); ?>",
                    method:'GET',
                    data:{string_search:string_search},
                    success:function(res){
...
<?php /**PATH C:\xampp\htdocs\nexelit\core\resources\views/backend/pages/job-history/history-js.blade.php ENDPATH**/ ?>