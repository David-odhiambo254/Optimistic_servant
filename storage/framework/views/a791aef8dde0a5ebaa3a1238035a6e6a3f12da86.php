            ...
            <div class="col-lg-12">
                <div class="customMarkup__single">
                    <div class="customMarkup__single__item">
                        <h4 class="customMarkup__single__title"><?php echo e(__('Seo Settings')); ?></h4>
                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
<?php endif; ?>
                        <div class="customMarkup__single__inner mt-4">
                            <form action="<?php echo e(route('admin.general.settings.seo')); ?>" method="POST" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <div class="single-input mb-3">
                                    <label for="site_meta_tags" class="label-title"><?php echo e(__('Site Meta Tags')); ?></label>
                                ...
                                <div class="single-input mb-3">
                                    <label for="site_meta_description" class="label-title"><?php echo e(__('Site Meta Description')); ?></label>
                                ...
                                <div class="single-input mb-3">
                                    <label for="og_meta_title" class="label-title"><?php echo e(__('Og Meta Title')); ?></label>
                                    <input type="text" name="og_meta_title"  class="form-control"  value="<?php echo e(get_static_option('og_meta_title')); ?>" id="og_meta_title">
                                </div>
                                <div class="single-input mb-3">
                                    <label for="og_meta_description" class="label-title"><?php echo e(__('Og Meta Description')); ?></label>
                                ...
                                <div class="single-input mb-3">
                                    <label for="og_meta_site_name" class="label-title"><?php echo e(__('Og Meta Site Name')); ?></label>
                                ...
                                <div class="single-input mb-3">
                                    <label for="og_meta_url" class="label-title"><?php echo e(__('Og Meta URL')); ?></label>
                                    <input type="text" name="og_meta_url"  class="form-control"  value="<?php echo e(get_static_option('og_meta_url')); ?>" id="og_meta_url">
                                </div>
                                <div class="single-input mb-3">
                                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.image','data' => ['title' => __('Og Meta Image Image'),'name' => 'og_meta_image','dimentions' => '1920x600']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Og Meta Image Image')),'name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('og_meta_image'),'dimentions' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('1920x600')]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
