...
<?php endif; ?>
                        <div class="customMarkup__single__inner mt-4">
                            <form action="<?php echo e(route('admin.payment.settings.info')); ?>" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="switch">
                                    <label class="label-title mt-3"><strong><?php echo e(__('Enable Force SSL Redirection')); ?></strong></label>
                                    <input class="custom-switch" type="checkbox" id="enable_disable_decimal_point" name="enable_disable_decimal_point" <?php if(!empty(get_static_option('enable_disable_decimal_point'))): ?> checked <?php endif; ?>>
                                    <label class="switch-label" for="enable_disable_decimal_point"><?php echo e(__('Enable/Disable Decimal Point')); ?></label>
                                </div>
                                <div class="single-input">
