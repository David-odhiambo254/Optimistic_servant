    ...
    (function($){
        ...
        $(document).ready(function(){
            ...
            $(document).on('click', '.update_rating', function(e){
                    ...
                    erContainer.html('');
                    $.ajax({
                        url:"<?php echo e(route('admin.feedback.edit')); ?>",
                        ...
                        success: function(res){
                            if(res.status=='success'){
                                ...
                                $('#reviewForm')[0].reset();
                                location.reload();
                                toastr_success_js("<?php echo e(__('Feedback Successfully Updated.')); ?>")
                            }
            ...
            function feedbacks(page,string_search){
                $.ajax({
                     url:"<?php echo e(route('admin.feedback.paginate.data').'?page='); ?>" + page,
            ...
            $(document).on('keyup','#string_search',function(){
                ...
                $.ajax({
                    url:"<?php echo e(route('admin.feedback.search')); ?>",
                    method:'GET',
                    data:{string_search:string_search},
                    success:function(res){
...
<?php /**PATH C:\xampp\htdocs\nexelit\core\resources\views/backend/pages/feedback/feedback-js.blade.php ENDPATH**/ ?>