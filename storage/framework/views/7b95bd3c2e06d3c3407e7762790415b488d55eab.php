<?php $__env->startSection('title', __('Custom JS')); ?>
            ...
            <div class="col-lg-12">
                <div class="customMarkup__single">
                    <div class="customMarkup__single__item">
                        <h4 class="customMarkup__single__title"><?php echo e(__('Custom JS')); ?></h4>
...
<?php endif; ?>
                        <div class="customMarkup__single__inner mt-4">
                            <form action="<?php echo e(route('admin.general.settings.custom.js')); ?>" method="POST" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <div class="single-input mb-3">
                                    <label for="message" class="label-title"><?php echo e(__('Message')); ?></label>
                                    <textarea class="form-control" name="custom_js_area" id="custom_js_area" cols="30" rows="10"><?php echo e($custom_js); ?></textarea>
                                </div>
