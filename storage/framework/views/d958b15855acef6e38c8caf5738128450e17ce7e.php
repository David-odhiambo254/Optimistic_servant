                            ...
                            <div class="activities-single-table mt-4">
                                <table class="table table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if($order->payment_status == '' || $order->payment_status == 'cancel'): ?>
                                                <span class="btn btn-danger btn-sm"><?php echo e(__('Cancel')); ?></span>
                                            <?php elseif($order->payment_status == 'pending'): ?>
                                                <span class="btn btn-warning btn-sm"><?php echo e(ucfirst($order->payment_status)); ?></span>
                                            <?php else: ?>
                                                <span class="btn btn-success btn-sm"><?php echo e(ucfirst($order->payment_status)); ?></span>
                                            <?php endif; ?>
                                        </td>
